...
from engine.clients.oracle23ai import (
    Oracle23aiConfigurator,
    Oracle23aiSearcher,
    Oracle23aiUploader,
)
...
ENGINE_CONFIGURATORS = {
    ...
    "oracle23ai": Oracle23aiConfigurator,
}
